...
@Component
@Profile("preprod")
public class IdentityAuthenticationProviderPreProd implements IdentityAuthenticationProvider {

	private static final Logger log = LoggerFactory.getLogger(IdentityAuthenticationProviderPreProd.class);
